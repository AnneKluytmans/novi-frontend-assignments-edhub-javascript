...
function minutesToSeconds(minutes) {
    return `${minutes} minuten is ${minutes * 60} seconden.`;
}

const numberOfSeconds = minutesToSeconds(6);
...
const mergeWord = merge('abra', 'cadabra');
...
const myDogAge = calculateDogYears(6);
