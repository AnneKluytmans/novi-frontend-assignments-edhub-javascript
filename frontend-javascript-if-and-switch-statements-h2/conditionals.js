...
const compareNumbers1 = 10 > 20;
console.log("Is 10 groter dan 20?", compareNumbers1);
...
console.log("Is zoet hetzelfde woord als sappig?", compareWords);
...
const grade = 9;
const cumLaude = grade > 8;

if (cumLaude) {
    console.log("Cum laude!");
}
else {
    console.log("Helaas, geen cum laude.");
}
