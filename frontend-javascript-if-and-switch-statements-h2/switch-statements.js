...
const monitorColorBonus = "green";

if (monitorColorBonus === "green") {
    console.log("Hartslag stabiel");
} else if (monitorColorBonus === "yellow") {
    console.log("Hartslag verhoogd");
} else if (monitorColorBonus === "red" || monitorColorBonus === "orange") {
    console.log("Kritieke hartslag, actie vereist!");
} else {
    console.log("Status hartslag onbekend");
}